...
const MyVehiclesPage = () => {
  ...
  const handleNewReservation = (vehicleId) => {
    navigate(`/new-reservations/${vehicleId}`);
  };
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8 gap-4">
          <div>
            ...
            <p className="text-slate-400">
              Gérez votre parc automobile ({vehicles.length} véhicule
              {vehicles.length > 1 ? "s" : ""})
            </p>
          </div>
            ...
            {vehicles.map((vehicle) => (
              ...
              >
                ...
                <div className="space-y-2 text-sm mb-4">
                  ...
                  <div className="flex justify-between">
                    <span className="text-slate-400">Services effectués</span>
                ...
                <div className="space-y-2">
                  <button
                    ...
                    className="w-full px-4 py-2.5 bg-purple-600/20 hover:bg-purple-600/30 border border-purple-500/30 text-purple-400 rounded-lg font-semibold transition-all text-sm flex items-center justify-center gap-2 group/btn"
                  >
                    <svg
