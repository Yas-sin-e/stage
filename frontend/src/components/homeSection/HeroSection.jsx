    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        ...
        <p className="text-lg text-slate-400 mb-12 max-w-3xl mx-auto leading-relaxed">
          Suivez vos réparations en temps réel • Obtenez des devis instantanés •
          Discutez avec l'IA
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {[
            ...
            {
              value: "24/7",
              label: "Assistant IA disponible",
              gradient: "from-purple-400 to-pink-400",
            },
            {
              value: "Gratuit",
              label: "Inscription & essai",
            ...
            >
              ...
              <div
                className={`absolute inset-0 bg-gradient-to-br ${stat.gradient.replace("from-", "from-").replace("to-", "to-")}/10 opacity-0 group-hover:opacity-100 transition-opacity`}
              />

              <div className="relative z-10">
                <div
                  className={`text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r ${stat.gradient} mb-2`}
                >
                  {stat.value}
                </div>
        ...
        <div className="mt-16 flex flex-wrap justify-center gap-4">
          {["✓ Sécurisé", "✓ Devis instantanés", "✓ Support 24/7"].map(
            (badge, i) => (
              <span
                key={i}
